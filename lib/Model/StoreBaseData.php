...
'default_payment_method' => 'getDefaultPaymentMethod'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['invoice_expiration'] = isset($data['invoice_expiration']) ? $data['invoice_expiration'] : null;
        $this->container['monitoring_expiration'] = isset($data['monitoring_expiration']) ? $data['monitoring_expiration'] : null;
        ...
        $this->container['on_chain_with_ln_invoice_fallback'] = isset($data['on_chain_with_ln_invoice_fallback']) ? $data['on_chain_with_ln_invoice_fallback'] : false;
        ...
        $this->container['lazy_payment_methods'] = isset($data['lazy_payment_methods']) ? $data['lazy_payment_methods'] : false;
     ...
     *
     * @return AllOfStoreBaseDataInvoiceExpiration
     */
     ...
     *
     * @param AllOfStoreBaseDataInvoiceExpiration $invoice_expiration The time after which an invoice is considered expired if not paid. The value will be rounded down to a minute.
     *
     * @return $this
     */
     ...
     *
     * @return AllOfStoreBaseDataMonitoringExpiration
     */
     ...
     *
     * @param AllOfStoreBaseDataMonitoringExpiration $monitoring_expiration The time after which an invoice which has been paid but not confirmed will be considered invalid. The value will be rounded down to a minute.
     *
     * @return $this
     */
     ...
     *
     * @param bool $on_chain_with_ln_invoice_fallback Include lightning invoice fallback to on-chain BIP21 payment url.
     *
     * @return $this
     */
     ...
     *
     * @param bool $lazy_payment_methods If true, payment methods are enabled individually upon user interaction in the invoice
     *
     * @return $this
     */
     ...
     *
     * @param string $default_payment_method The default payment method to load when displaying an invoice. It can be in the format of `BTC_LightningNetwork` to specify Lightning to be the default or `BTC_OnChain`/ `BTC` for on-chain to be the default.
     *
     * @return $this
     */
